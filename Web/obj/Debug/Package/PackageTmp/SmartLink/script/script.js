    ...
    if (hash != '') {
        ...
        if (arr.length >= 2) {
            ...
            if (arr[1] == 'F') {
                ...
                $('#Div3 .pay-finish').html('<div class="pay-background finish-icon unsuccess-icon"></div><div class="success-icon"><h2 class="unsuccess">Thanh toán không thành công</h2><p>' + sErr + '</p><p>' + sSorry + '<p><p align="center"><a href="/SmartLink/"><strong>Thực hiện tiếp thanh toán</strong></a></p><p>&nbsp;</p></div>');
            }
        }
    }
});
