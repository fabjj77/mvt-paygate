<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Web.SmartLink.Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script src="/SmartLink/script/script.js" type="text/javascript"></script>
</asp:Content>
        ...
        <div class="fullwidth" id="avg-main-content">
            <div class="pay-left">
                <div class="pay">
                    ...
                    <h1 class="pay-h1">
                        Hệ thống thanh toán cước THAV bằng tài khoản Smartlink</h1>
                    <div class="banknet-info" id="banknet-infor" style="display: none;">
                        <div class="banknet-what-bg banknet-infor-head">
                            <a class="pay-background close" href="javascript:void(0);">&nbsp;</a></div>
                            ...
                            <div class="pay-finish pay-sucess">
                                ...
                                <div class="success-icon">
    	                            <h2 class="success">Thanh toán thành công</h2>
			                            ...
			                            <p align="center"><a href="/SmartLink/"><strong>Thực hiện tiếp thanh toán</strong></a></p>
			                            <p>&nbsp;</p>
                                </div>
                              </div>
                        </div>
