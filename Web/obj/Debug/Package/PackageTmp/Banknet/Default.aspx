<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Web.Banknet.Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script src="/Banknet/script/script.js" type="text/javascript"></script>
</asp:Content>
        ...
        <div class="fullwidth" id="avg-main-content">
            <div class="pay-left">
                <div class="pay">
                    ...
                    <h1 class="pay-h1">
                        Hệ thống thanh toán cước THAV bằng tài khoản ngân hàng</h1>
                    <div class="banknet-info" id="banknet-infor" style="display: none;">
                        <div class="banknet-what-bg banknet-infor-head">
                            <%--<img src="">--%><a class="pay-background close" href="javascript:void(0);">&nbsp;</a></div>
                    ...
                    <div class="pay-wrapper banknet">
                                ...
                                <div class="pay-field-content">
                                    ...
                                    <div class="help">
                                        <div style="display: none;" class="radiums" id="smartCardInfo">
                                            ...
                                            <div class="content">
                                                <h3>Cách 1: Tìm số thẻ bằng cách sử dụng điều khiển đầu thu và màn hình TV</h3>
                                                <center>
                                                    ...
                                                    <p style="text-align: center;">
                                                        <a href="http://www.anvien.tv/wp-content/uploads/2012/05/b3-c2.png">
                                                            <img width="380" alt="" src="http://www.anvien.tv/wp-content/uploads/2012/05/b3-c2.png" title="b3-c2" class="aligncenter size-full wp-image-50125">
                                                        </a>
                                                    </p>
                                                </center>
                                            </div>
                        ...
                        <div id="Div2">
                            ...
                            <div class="pay-background pay-field">
                                ...
                                <div class="pay-field-content">
                                    <div class="pay-head head-step"><b>Thông tin giao dịch:</b></div>
                                    <div class="field-left">
                                        <div class="pay-color" style="margin-top: 6px;"><b>Chọn gói cước:</b></div>
                                        <div class="pay-input">
                                            <select class="DDLType" id="vouchers" name="vouchers">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="pay-button">
                                <input type="button" tabindex="5" class="pay-background payment-submit" value="Giao dịch"
                            ...
                            <div class="pay-finish pay-sucess">
                                ...
                                <div class="success-icon">
    	                            <h2 class="success">Thanh toán thành công</h2>
			                            <p>&nbsp;</p>
                                        <p>Thời hạn hợp đồng của bạn kéo dài đến <b><span id="Span_Time"><%=sDate %></span></b></p>
			                            <p align="center"><a href="/Banknet/"><strong>Thực hiện tiếp thanh toán</strong></a></p>
			                            <p>&nbsp;</p>
                                </div>
                              </div>
                        </div>
